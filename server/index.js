...
/******/ 	var hotCurrentHash = "23ddb8f0b55f7fbd82d5"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tvshows = __webpack_require__(10);
	...
	_mongoose2.default.connect('mongodb://localhost/tvshows', function (err, res) {
	  if (err) {
	    throw err;
	  };
	...
	// API routes
	var tvshows = _express2.default.Router();
	
	tvshows.route('/tvshows').get(_tvshows2.default.findAllTVShows).post(_tvshows2.default.addTVShow);
	
	tvshows.route('/tvshows/:id').get(_tvshows2.default.findById).put(_tvshows2.default.updateTVShow).delete(_tvshows2.default.deleteTVShow);
	...
	if (true) {
	  ...
	  module.hot.accept(167, function () {
	    ...
	    Html = __webpack_require__(167).default;
	  });
	
	  module.hot.accept(168, function () {
	    console.info('[HMR] Patching Route');
	
	    Route = __webpack_require__(168).default;
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.addTVShow = function (req, res) {
	  ...
	  tvshow.save(function (err, tvshowSaved) {
	    if (err) {
	      return res.status(500).send(err.message);
	    };
	    res.status(200).jsonp(tvshowSaved);
	  });
	};
	...
	exports.deleteTVShow = function (req, res) {
	  TVShow.findById(req.params.id, function (err, tvshow) {
	    tvshow.remove(function (errRemove) {
	      if (errRemove) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer = __webpack_require__(163);
	...
	function configureStore(initial_state) {
	  var store = createStoreWithMiddleware(_reducer2.default, initial_state);
	
	  if (true) {
	    module.hot.accept(163, function () {
	      var next_reducer = __webpack_require__(163).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxSimpleRouter = __webpack_require__(164);
	
	var _counterReducer = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _counterAction = __webpack_require__(166);
	...
	function Html(props) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement('meta', { name: 'author', content: 'Hermanos Clever' }),
	      _react2.default.createElement('meta', { name: 'description', content: metadata ? metadata.description : 'Sin definir' }),
	      _react2.default.createElement('meta', { name: 'keywords', content: metadata ? metadata.keywords : 'Sin definir' }),
	      _react2.default.createElement('meta', { property: 'og:title', content: metadata ? metadata.title : 'Sin definir' }),
	      _react2.default.createElement('meta', { property: 'og:site_name', content: 'El Caso' }),
	      _react2.default.createElement('meta', { property: 'og:description', content: metadata ? metadata.description : 'Sin definir' }),
	      _react2.default.createElement('meta', { property: 'og:image', content: metadata ? metadata.image : 'Sin definir' }),
	      _react2.default.createElement('meta', { property: 'og:type', content: 'website' }),
	      _react2.default.createElement('meta', { property: 'og:locale', content: 'es_ES' }),
	      _react2.default.createElement('meta', { property: 'og:image:width', content: '714' }),
	      _react2.default.createElement('meta', { property: 'og:image:height', content: '865' }),
	      _react2.default.createElement(
	        'title',
	        null,
	        metadata ? metadata.title : 'Sin definir'
	      ),
	      _react2.default.createElement('meta', { name: 'viewport', content: 'width=device-width, initial-scale=1' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '57x57', href: 'static/images/icon/apple-icon-57x57.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '60x60', href: 'static/images/icon/apple-icon-60x60.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '72x72', href: 'static/images/icon/apple-icon-72x72.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '76x76', href: 'static/images/icon/apple-icon-76x76.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '114x114', href: 'static/images/icon/apple-icon-114x114.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '120x120', href: 'static/images/icon/apple-icon-120x120.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '144x144', href: 'static/images/icon/apple-icon-144x144.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '152x152', href: 'static/images/icon/apple-icon-152x152.png' }),
	      _react2.default.createElement('link', { rel: 'apple-touch-icon', sizes: '180x180', href: 'static/images/icon/apple-icon-180x180.png' }),
	      _react2.default.createElement('link', { rel: 'icon', type: 'image/png', sizes: '192x192', href: 'static/images/icon/android-icon-192x192.png' }),
	      _react2.default.createElement('link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: 'static/images/icon/favicon-32x32.png' }),
	      _react2.default.createElement('link', { rel: 'icon', type: 'image/png', sizes: '96x96', href: 'static/images/icon/favicon-96x96.png' }),
	      _react2.default.createElement('link', { rel: 'icon', type: 'image/png', sizes: '16x16', href: 'static/images/icon/favicon-16x16.png' }),
	      _react2.default.createElement('link', { rel: 'stylesheet', href: 'static/styles/styles.css', type: 'text/css' }),
	      _react2.default.createElement('link', { rel: 'stylesheet', href: 'static/styles/fonts.css', type: 'text/css' }),
	      ...
	      function () {
	        ...
	        return _react2.default.createElement('link', { rel: 'icon', href: 'data:;base64,iVBORw0KGgo=' });
	      }()
	    ),
	    _react2.default.createElement(
	      'body',
	      ...
	      _react2.default.createElement('script', { src: script })
	    )
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactStyling = __webpack_require__(171);
	...
	var Menu = function (_Component) {
	  ...
	  _createClass(Menu, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'header',
	        { className: 'container', style: style.header },
	        _react2.default.createElement(
	          'a',
	          { style: style.img, href: 'http://hermanosclever.com/', target: '_blank' },
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { to: '/', style: style.menu.item.link, activeClassName: 'selected', className: 'menu-item' },
	              'Home'
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/contador', style: style.menu.item.link, activeClassName: 'selected', className: 'menu-item' },
	              'Contador'
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function (_Component) {
	  ...
	  _createClass(Footer, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var url = 'https://github.com/HermanosClever/boilerplateReduxUniversal';
	      return _react2.default.createElement(
	        'footer',
	        { style: style.footer },
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'svg',
	                { 'aria-hidden': 'true', height: '28', version: '1.1', viewBox: '0 0 16 16', width: '28' },
	...
	var CounterView = exports.CounterView = function (_Component) {
		...
		_createClass(CounterView, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'section',
					{ className: 'table', style: style.container },
					_react2.default.createElement(
						'div',
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('img', { src: 'static/images/logo.png', style: style.image })
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactGoogleLogin = __webpack_require__(178);
